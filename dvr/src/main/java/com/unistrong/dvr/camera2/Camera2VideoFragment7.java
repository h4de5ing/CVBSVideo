...
public class Camera2VideoFragment7 extends Fragment implements View.OnClickListener, FragmentCompat.OnRequestPermissionsResultCallback {
    ...
    public static Camera2VideoFragment7 newInstance() {
        return new Camera2VideoFragment7();
    }
