 ...
 *
 * */
public class MainActivity7in extends Activity implements View.OnClickListener {
    ...
    private static final int VIDEO6 = 4;
    private static final int VIDEO7 = 5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Constants.zhi = (int) SPUtils.getSp(MainActivity7in.this, Constants.STANDARD_KEY, 1);
        startVideoService();
    ...
    private void startVideoService() {
        Intent intent = new Intent(MainActivity7in.this, VideoService.class);
        startService(intent);
    }
